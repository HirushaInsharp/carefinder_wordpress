...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220726_carefinderblog_eb1ab71957611a779596_20220726102443_archive.zip';
	const ARCHIVE_SIZE		 = '38146397';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'eb1ab71-26102443';
    const SECONDARY_PACKAGE_HASH = 'b2813d9-26102443';
	const VERSION			 = '1.4.7';
